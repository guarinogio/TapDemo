...
static class VertexDirt {
	...
	*/
	var globalOccluderColor : Color32 = Color32(71,71,71,255);
	...
	*/
	...
	// using tex.Apply() on the VDSampler
	var compatibilityMode : boolean = false;
	
	// 	legacymode is when we are not using rendertextures to run on 4.x indie
	...
	*/
    ...
    function Dirt(sels : Object[], passes : VDPass[]) {
	}
